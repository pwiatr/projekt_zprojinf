...
public class ExtendedUserResourceIntTest {
    ...
    public void setup() {
        MockitoAnnotations.initMocks(this);
            ExtendedUserResource extendedUserResource = new ExtendedUserResource(extendedUserRepository, extendedUserSearchRepository);
    ...
    public void createExtendedUserWithExistingId() throws Exception {
        ...
        restExtendedUserMockMvc.perform(post("/api/extended-users")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(existingExtendedUser)))
