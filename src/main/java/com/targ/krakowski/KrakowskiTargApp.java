...
public class KrakowskiTargApp {
    ...
    public KrakowskiTargApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes krakowskiTarg.
     * <p>
...
//    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(KrakowskiTargApp.class);
